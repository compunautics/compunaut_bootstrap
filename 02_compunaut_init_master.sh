...
# Set up KVM
  ...
  salt 'salt*' state.apply compunaut_hypervisor.ssh,compunaut_hypervisor.kvm --state_output=mixed
  sleep 60

  salt 'salt*' state.apply compunaut_hypervisor.network,compunaut_salt.master --state_output=mixed
